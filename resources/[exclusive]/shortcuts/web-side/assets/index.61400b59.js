...
let w;
function K(e, t) {
  return w || (w = document.createElement("a")), (w.href = t), e === w.href;
}
function ue(e) {
...
function Y() {
  ...
  do {
    ...
    for (g(null), _.length = 0, E = 0; q.length; ) q.pop()();
...
function be(e, t, n, i) {
  ...
  r && r.m(t, n),
    i ||
      A(() => {
        const s = e.$$.on_mount.map(V).filter(X);
        e.$$.on_destroy ? e.$$.on_destroy.push(...s) : $(s),
          (e.$$.on_mount = []);
      }),
    o.forEach(A);
}
...
function we(e, t) {
  e.$$.dirty[0] === -1 && (_.push(e), ve(), e.$$.dirty.fill(0)),
    (e.$$.dirty[(t / 31) | 0] |= 1 << t % 31);
}
function Ee(e, t, n, i, r, o, s, f = [-1]) {
  const u = b;
  g(e);
  const c = (e.$$ = {
    fragment: null,
  ...
  if (
    ((c.ctx = n
      ? n(e, t.props || {}, (d, T, ...F) => {
          const I = F.length ? F[0] : T;
          return (
            c.ctx &&
              r(c.ctx[d], (c.ctx[d] = I)) &&
              (!c.skip_bound && c.bound[d] && c.bound[d](I), a && we(e, d)),
            T
          );
        })
      : []),
...
l.prototype.emit = function (t) {
  ...
  if (typeof u == "function") U(u, this, n);
  else for (var c = u.length, a = oe(u, c), i = 0; i < c; ++i) U(a[i], this, n);
  return !0;
};
function te(e, t, n, i) {
  var r, o, s;
...
l.prototype.once = function (t, n) {
  return j(n), this.on(t, ne(this, t, n)), this;
};
l.prototype.prependOnceListener = function (t, n) {
  return j(n), this.prependListener(t, ne(this, t, n)), this;
};
l.prototype.removeListener = function (t, n) {
  var i, r, o, s, f;
  if ((j(n), (r = this._events), r === void 0)) return this;
...
l.prototype.removeAllListeners = function (t) {
  ...
  if (arguments.length === 0) {
    ...
    for (r = 0; r < o.length; ++r)
      (s = o[r]), s !== "removeListener" && this.removeAllListeners(s);
    return (
...
function Ne(e, t) {
  return new Promise(function (n, i) {
    ...
    se(e, t, o, { once: !0 }), t !== "error" && Ce(e, r, { once: !0 });
  });
}
function Ce(e, t, n) {
  typeof e.on == "function" && se(e, "error", t, n);
}
function se(e, t, n, i) {
...
const R = new P.exports.EventEmitter();
addEventListener("message", (e) => R.emit(e.data.name, e.data.payload));
function D(e, t) {
  R.on(e, t), he(() => R.removeListener(e, t));
}
function H(e, t, n) {
  const i = e.slice();
  return (i[2] = t[n][0]), (i[3] = t[n][1]), i;
}
function G(e) {
  let t,
    n,
    ...
    r = [];
  for (let o = 0; o < i.length; o += 1) r[o] = Q(H(e, i, o));
  return {
    c() {
      (t = m("div")), (n = m("div"));
      ...
      p(
        n,
        "class",
        "absolute bottom-14 grid grid-cols-5 place-items-center gap-3"
      ),
        p(
          t,
          "class",
    ...
    m(o, s) {
      k(o, t, s), h(t, n);
      for (let f = 0; f < r.length; f += 1) r[f].m(n, null);
    },
    p(o, s) {
      if (s & 2) {
        ...
        for (f = 0; f < i.length; f += 1) {
          const u = H(o, i, f);
          r[f] ? r[f].p(u, s) : ((r[f] = Q(u)), r[f].c(), r[f].m(n, null));
        }
...
function J(e) {
  ...
  return {
    c() {
      (t = m("img")),
        K(t.src, (n = "nui://inventory/web-side/inventory/" + e[3] + ".png")) ||
          p(t, "src", n),
        p(t, "alt", "");
    },
    m(i, r) {
    ...
    p(i, r) {
      r & 2 &&
        !K(t.src, (n = "nui://inventory/web-side/inventory/" + i[3] + ".png")) &&
        p(t, "src", n);
    },
    d(i) {
      i && L(t);
  ...
  return {
    c() {
      (t = m("div")),
        ...
        u && u.c(),
        (f = W()),
        p(i, "class", "text-xs text-black font-semibold"),
        p(
          n,
          "class",
          "w-[1.125rem] h-[1.125rem] absolute -bottom-2 grid place-items-center bg-white rounded-sm"
        ),
        p(
          t,
          "class",
          "w-[4.75rem] h-[4.75rem] relative grid place-items-center bg-black/60 rounded"
        );
    },
    m(c, a) {
      k(c, t, a),
