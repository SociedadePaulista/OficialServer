...
Config = {
    ...
    TextUI = 'ox_lib', -- 'ox_lib' / 'okokTextUI' / 'ESXTextUI' / 'brutal_textui' // Custom can be add in the cl_utils.lua!!!
    ...
    ReviveReward = 100, -- set to 0 if you don't want to use it.
    ...
    NPCMedicers = {
        -- GABZ Hospital Coords
        {price = 100, time = 30, coords = vector3(318.8537, -585.8278, 43.2841), bedcoords = vector3(317.7270, -585.3508, 44.2040), bedheading = 338.0, prop = 'v_med_bed2'},
    ...
    Texts = {
        ...
        [7] = {'[E] - To Duty ON', '[E] - To Duty OFF', 38},
        [8] = {'[E] - To use the Bed', 38},
        [9] = {'[X] - To leave the Bed', 73},
