...
function Creative.Salary()
	...
	if Passport then
		...
		TriggerEvent("inventory:BuffServer",source,Passport,"Dexterity",Valuation)
		TriggerClientEvent("Notify",source,"verde","Recebeu <b>R$"..parseFormat(1200).."</b> em sua conta bancária.",500,"Salário Taxista")
	end
end
-----------------------------------------------------------------------------------------------------------------------------------------
-- 
...
function Creative.insuranceUnemployment(Amount)
	...
	if Passport then
		if Amount >= 30 then
			...
			vRP.GiveBank(Passport, Valuation)
			TriggerClientEvent("sounds:Private",source,"coins",0.25)
			TriggerClientEvent("Notify",source,"verde","Recebeu <b>R$"..parseFormat(1200).."</b> em sua conta bancária.",500,"Seguro-Desemprego")
		end
	end
end
-----------------------------------------------------------------------------------------------------------------------------------------
